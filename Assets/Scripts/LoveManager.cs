...
public class LoveManager : MonoBehaviour
{
    ...
    private int maxLoveLocIndex = 68; // number of LOVE_X key + value pairs in loc csv; i.e. values go from LOVE_0 to LOVE_68
    private int maxToughLoveLocIndex = 68; // number of TOUGH_LOVE_X key + value pairs in loc csv; i.e. values go from TOUGH_LOVE_0 to TOUGH_LOVE_68
